...
def warmup_cosine_schedule(peak_lr=1.0e-6, final_lr=1.0e-7, warmup_pct=0.2, decay_pct=0.2):
...
class YopoAlgorithm:
    def __init__(
        ...
        self.learning_rate = warmup_cosine_schedule(peak_lr=learning_rate, final_lr=1.0e-7, warmup_pct=0.2, decay_pct=0.2)
